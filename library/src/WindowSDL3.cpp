...
void Window::createSwapchain()
{
    ...
    m_swapchainExtent = ChooseExtent(caps, m_sdlWindow);
...
// Frame
// -------------------------------------------------------------------
VkCommandBuffer Window::beginFrame()
{
...
VkInstance       Window::getInstance() const       { return m_instance; }
VkPhysicalDevice Window::getPhysicalDevice() const { return m_physicalDevice; }
VkDevice         Window::getDevice() const         { return m_device; }
VkRenderPass     Window::getRenderPass() const     { return m_renderPass; }
VkExtent2D       Window::getSwapchainExtent() const { return m_swapchainExtent; }
VkFormat         Window::getSwapchainFormat() const { return m_swapchainFormat; }
